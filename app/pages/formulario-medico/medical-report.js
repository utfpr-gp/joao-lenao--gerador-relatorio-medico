...
(function () {
   ...
   * @function
   */
  function validateSymptomsOnFormChange() {
  ...
  function enableSubmitButtonOnFormChange() {
    ...
    //monitora as mudanças nos campos de sintomas para atualizar o estado de validação do formulário para permitir ou não a submissão com base se pelo menos um dos sintomas está marcado.
    validateSymptomsOnFormChange();
